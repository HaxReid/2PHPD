        ...
        <div>   
            <div>
                ...
                <?php
                    ...
                    $req = "SELECT id_film, image, titre, description, genre, acteurs, prix, temps, nom, prenom FROM film INNER JOIN realisateur ON film.id_realisateur = realisateur.id_realisateur WHERE genre LIKE '%Action%'";
